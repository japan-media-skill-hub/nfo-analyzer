...
> 以下为通用示例映射，仅用于说明“多别名归一”的用法。

| 统一后标签 | 合并来源示例 |
|-----------|-------------|
| Studio-A | Studio A, STUDIO_A |
| Studio-B | Studio B, STUDIO_B |
| Label-X | Label X, LABEL_X |
| Label-Y | Label Y |

### 已合并的风格示例 (genre)

> 以下为通用示例映射，仅用于说明“同义词/多语言风格归一”的用法。

| 统一后风格 | 合并/翻译来源示例 |
|-----------|------------------|
| 风格-剧情 | 剧情向, Story |
| 风格-高清 | 高清版, HD |
| 风格-互动 | 互动型, Interactive |
| 风格-合集 | 合集版, Collection |
